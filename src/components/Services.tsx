      ...
      <div className="space-y-8">
        <div className="p-0">
          ...
          <p className="text-slate-600 leading-8 mb-6">
            CTN-ET offers comprehensive support across the entire lifecycle of
            clinical trials from initial planning to implementation and
            reporting. The network connects investigators, institutions, and
            partners to ensure trials are conducted efficiently and in
        ...
        <div className="p-0">
          ...
          <p className="text-slate-600 leading-8 mb-6">
            CTN-ET hosts a national platform that registers ongoing and
            completed clinical trials conducted in Ethiopia, promoting
            transparency and accessibility of clinical research information.
          </p>
          <p className="font-semibold text-slate-800 mb-4">
        ...
        <div className="p-0">
          ...
          <p className="text-slate-600 leading-8 mb-6">
            Strengthening human resource capacity is central to CTN-ET&apos;s
            mission. The network organizes workshops, short courses, and
            professional training programs to enhance knowledge and skills in
            clinical research.
          </p>
          <p className="font-semibold text-slate-800 mb-4">
          ...
          <p className="text-slate-600 leading-8 mt-6">
            These programs support investigators, clinicians, laboratory
            professionals, and research coordinators in conducting high-quality
            clinical research.
          </p>
        </div>
        ...
        <div className="p-0">
          ...
          <p className="text-slate-600 leading-8 mb-6">
            CTN-ET provides expert technical guidance to researchers,
            institutions, and partners involved in clinical research.
          </p>
          <p className="font-semibold text-slate-800 mb-4">
      ...
      <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          <div className="relative z-10">
            <h4
              className={`text-3xl font-bold text-white mb-4 ${headingClass}`}
            >
              {t.nav.volunteer}
            </h4>
            <p className="text-white/75 text-lg mb-7 max-w-[320px]">
              Join our national volunteer database and support ethical evidence
        ...
        <div className="bg-slate-50 p-8 rounded-[2.5rem] border border-slate-200">
          ...
          <p className="text-slate-600 mb-6 leading-7">
            Contact our team to discuss clinical trial planning, partnerships,
            compliance, or training support.
          </p>
