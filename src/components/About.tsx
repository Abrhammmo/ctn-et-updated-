...
export default function About({ lang, t }: AboutProps) {
  const title = lang === 'am' ? t.about?.title ?? aboutPage.title : aboutPage.title;
    ...
    >
      ...
      <header className="grid grid-cols-1 sm:grid-cols-[1.05fr_0.95fr] gap-8 md:gap-12 items-center mb-10">
        <div className="min-w-0">
          ...
          <h2 className={`text-4xl md:text-5xl font-bold text-slate-900 mb-6 ${titleClass}`}>{title}</h2>
          <p className="text-lg md:text-xl text-slate-600 leading-relaxed">{aboutPage.summary}</p>
        </div>
      ...
      <div className="space-y-20">
        ...
        >
          <div>
            <div className="flex items-center gap-3 mb-5 text-slate-900">
              ...
              <div>
                ...
                <h3 className="text-2xl md:text-3xl font-bold">What CTN-ET is building</h3>
              </div>
            </div>
          ...
          <aside className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.2em] text-slate-500">Who is involved</p>
                <h4 className="text-xl font-bold text-slate-900">Network stakeholders</h4>
              </div>
            </div>
            ...
            <ul className="space-y-4">
              {aboutPage.stakeholders.map((item) => (
                <li key={item} className="flex items-start gap-3 text-slate-700">
                  <CheckCircle2 size={18} className="shrink-0 mt-1 text-primary" />
                  <span>{item}</span>
                </li>
              ))}
            </ul>
        ...
        >
          <div className="md:pr-10 md:border-r md:border-slate-200">
            ...
            <p className="text-lg text-slate-600 leading-8">{aboutPage.vision}</p>
          </div>
          ...
          <div className="md:pl-4">
            ...
            <p className="text-lg text-slate-600 leading-8">{aboutPage.mission}</p>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-[0.95fr,1.05fr] gap-16 items-start">
          <div id="history" className="scroll-mt-28">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-slate-900">A milestone launched in 2025</h3>
              </div>
            </div>
            ...
            <div className="border-l border-slate-200 pl-6 space-y-8">
              {aboutPage.history.map((item) => (
                <div key={item.title} className="relative">
                  ...
                  <p className="text-sm font-semibold uppercase tracking-[0.18em] text-primary mb-2">{item.label}</p>
          ...
          <div id="objectives" className="scroll-mt-28">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.24em] text-slate-500">Objectives</p>
                <h3 className="text-2xl md:text-3xl font-bold text-slate-900">What the network is set up to do</h3>
              </div>
            </div>
            ...
            <ul className="divide-y divide-slate-200 border-y border-slate-200">
              {aboutPage.objectives.map((item, index) => (
                <li key={item} className="flex items-start gap-4 py-5">
                  <span className="text-sm font-bold text-primary min-w-10 pt-1">
        ...
        <section id="why-ctn-et" className="scroll-mt-28 rounded-[2.5rem] bg-slate-900 text-white px-6 py-10 md:px-10 md:py-12">
          <div className="max-w-3xl mb-10">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.24em] text-white/60">Why CTN-ET</p>
                <h3 className="text-2xl md:text-3xl font-bold">Why a national platform matters now</h3>
              </div>
            </div>
            <p className="text-white/80 text-lg leading-8">{aboutPage.why.intro}</p>
          </div>
          ...
          <p className="mt-10 text-white/75 text-lg leading-8 max-w-3xl">{aboutPage.why.closing}</p>
        </section>
          ...
          <div>
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-slate-900">How the network is organized</h3>
              </div>
            </div>
            <p className="text-lg text-slate-600 leading-8">{aboutPage.governance.intro}</p>
          </div>

          <div className="space-y-8">
            <div className="border-l-4 border-primary pl-6">
              <h4 className="text-xl font-bold text-slate-900 mb-2">Steering Committee</h4>
              <p className="text-slate-600 leading-7">{aboutPage.governance.steering}</p>
            </div>

            <div className="border-l-4 border-secondary pl-6">
              <h4 className="text-xl font-bold text-slate-900 mb-2">Secretariat</h4>
              <p className="text-slate-600 leading-7">{aboutPage.governance.secretariat}</p>
            </div>

            <div className="border-l-4 border-slate-300 pl-6">
              <h4 className="text-xl font-bold text-slate-900 mb-2">Technical Working Groups</h4>
              <p className="text-slate-600 leading-7 mb-5">{aboutPage.governance.workingGroupsText}</p>
              ...
              <p className="text-slate-600 leading-7 mt-5">{aboutPage.governance.closing}</p>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.95fr,1.05fr] gap-10 items-start">
            <div>
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  <p className="text-sm font-semibold uppercase tracking-[0.24em] text-white/60">Join the Network</p>
                  <h3 className="text-2xl md:text-3xl font-bold">Collaborate with CTN-ET</h3>
                </div>
              </div>

              <p className="text-white/85 text-lg leading-8 mb-6">{aboutPage.join.intro}</p>
              <p className="text-white/70 leading-7 mb-8">{aboutPage.join.closing}</p>
            ...
            <div className="rounded-[2rem] bg-white/10 backdrop-blur-sm border border-white/10 p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h4 className="text-xl font-bold">Members gain opportunities to:</h4>
              </div>

              <ul className="space-y-4">
                {aboutPage.join.benefits.map((item) => (
                  <li key={item} className="flex items-start gap-3">
                    <CheckCircle2 size={18} className="shrink-0 mt-1 text-secondary" />
