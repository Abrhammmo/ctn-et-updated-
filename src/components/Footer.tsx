        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-3 mb-6 cursor-pointer" onClick={() => setView('home')}>
              ...
              <h1 className="text-xl font-bold text-primary tracking-tight">CTN-ET</h1>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-500 font-medium">
              ...
              <li><a href={`https://${t.contact.website}`} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">{t.contact.website}</a></li>
            </ul>
          </div>
        </div>
